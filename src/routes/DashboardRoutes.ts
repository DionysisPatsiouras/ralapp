...
export const AdminDashboardMenu = [
    ...
    //     link: '',
    //     children: [
    //         { id: uuid(), link: '/admin/users', name: 'Χρήστες' },
    //         { id: uuid(), link: '/admin/groups', name: 'Groups' },
    //         { id: uuid(), link: '/admin/percentages', name: 'Ποσοστά' },
    //         { id: uuid(), link: '/admin/manage_fdl', name: 'Διαχ. ΦΔΛ' }
    //     ]
    // },
    {
        id: uuid(),
